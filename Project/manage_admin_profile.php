	...
	<form method="POST" action="data_process/update_processes.php" autocomplete="off" accept-charset="UTF-8">
			...
			<div class="form-group">
			 ...
			 <img src="<?php echo $_SESSION["control"]["Profile_Image"];?> " class="img-fluid" alt="Photo"/>
				...
				<div class="form-group">
					   ...
					   <input class="btn btn-primary" type="submit" name="UpdateAdmin" value="Update Details">
			</div>
		...
		<div class="col-md-12">
			...
			<div class="form-group">
					   ...
					   <input class="btn btn-primary" type="submit" name="UpdateAdminPass" value="Update Password">
			</div>
		</div>
			</div>
			</div>
