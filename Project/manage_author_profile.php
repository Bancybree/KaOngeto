...
require "includes/session_control.php";
...
<div class="container">
	...
	<div class="row">
	<form method="POST" action="data_process/update_processes.php" autocomplete="off" accept-charset="UTF-8">
			...
			<div class="form-group">
			 ...
			 <img src="<?php echo $_SESSION["control"]["Profile_Image"];?> " class="img-fluid" alt="Photo"/>
				...
				<div class="form-group">
					   ...
					   <input class="btn btn-primary" type="submit" name="UpdateAuthor" value="Update Details">
			</div>
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				<label for="image"> Enter Current Password</label>
				<input placeholder="Enter Current Password" class="form-control form-control-md" name="OLDPASS"
					   type="password" id=""/>
					   </div>
			
			<div class="form-group">
			<label for="image"> Enter New Password</label>
				<input placeholder="Confirm New Password" class="form-control form-control-md" name="NEWPASS"
					   type="password" id=""/>
			...
			<div class="form-group">
					   ...
					   <input class="btn btn-primary" type="submit" name="UpdateAuthorPass" value="Update Password">
			</div>
		</div>
			</div>
			</div>
