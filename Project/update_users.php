...
<div class="jumbotron">
	<div class="container">
		<h1 class="display-3">Update User Details</h1>
	</div>
</div>
<div class="container">
	...
	<form method="POST" action="data_process/update_processes.php" autocomplete="off" accept-charset="UTF-8">
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<input placeholder="Enter New Password" class="form-control form-control-md" name="OLDPASS"
					   type="password" id=""/>
					   </div>
			...
			<div class="form-group">
					   ...
					   <input class="btn btn-primary" type="submit" name="UpdateSUPass" value="Update Password">
			</div>
		</div>
			</div>
	</form>
